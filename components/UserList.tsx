  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm text-center text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          {users?.map((user) => (
            <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700" key={user._id}>
              <th
                scope="row"
                className="flex items-center gap-2 px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"
              >
              ...
              {isDelete && (
                <div
                  ...
                  } overflow-y-auto overflow-x-hidden fixed top-[40%] right-[70%] left-[20%] z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full`}
                >
